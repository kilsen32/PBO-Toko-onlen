...
function BasicExample() {
  return (
    ...
    <div> 
      ...
      <div className='overflow-auto' style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end'}}>
        <Card style={{ width: '18rem', margin: '10px' }}>
        <Card.Img variant="top" src="/images/eiger.png" />
        <Card.Body>
            <Card.Title>EIGER</Card.Title>
            <Card.Text>
            Koleksi pakaian dan aksesoris pria terbaru dari Eiger, perlengkapan outdoor dan petualangan terkemuka di Indonesia.
            </Card.Text>
          </Card.Body>
        </Card>
        <Card style={{ width: '18rem', margin: '10px' }}>
        ...
        <Card style={{ width: '18rem', margin: '10px' }}>
        <Card.Img variant="top" src="/images/gucci-logo-transparent-free-png.webp" />
        <Card.Body>
